...
# Database Connection - create engine to hawaii.sqlite 
engine = create_engine("sqlite:///Resources/hawaii.sqlite")

# Reflect an existing database and tables into a new model
Base = automap_base()
...
def home():
    ...
    return(
        f"<b>Welcome to Hawaii Climate Page</b><br/>"
        f"<br/>"
...
def precipitation():
    # Create the session from python to DataBase
    session = Session(engine)
